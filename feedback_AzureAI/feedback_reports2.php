...
$user_rank = 'Customer';
$admin_identity =  strip_tags($_POST['admin_identity']);
...
// 
$result1 = $db->prepare('SELECT * FROM users where admin_id = :admin_id');
$result1->execute(array(':admin_id' => $admin_identity));
$row = $result1->fetch();
$uid = $row['id'];
