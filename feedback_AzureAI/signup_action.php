...
(password,fullname,email,photo,user_rank,user_verified,user_banned,created_time,timer1,data,status,points,levels,phone_no, admin_id)
...
$lastId = $res->fetchColumn();



// initialize feedback statistic table for admins

$statement1 = $db->prepare('INSERT INTO feedback_statistics
(total_sentiments,total_postive,total_negative,total_neutral,total_products,total_design,
total_bug,total_pricing,total_supports,total_others,owner_id)
...
.Redirecting in a second to Login Page.....<img src='loader.gif'><br></div>";
